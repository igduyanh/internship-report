...
| --- | --- | ------------ | --------------- | --------------- |
| 2 | Kích hoạt xác thực đa yếu tố (MFA) cho Root User.<br>- Tạo IAM User với quyền `AdministratorAccess` để sử dụng cho các tác vụ quản trị hằng ngày. | 15/06/2026 | 15/06/2026 | https://docs.aws.amazon.com/iam/ |
